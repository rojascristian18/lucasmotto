...
class ImagenesController extends AppController
{
	...
	public function admin_add()
	{
		...
		$sliderPosiciones	= $this->Imagen->SliderPosicion->find('list');
	...
	public function admin_edit($id = null)
	{
		...
		{
			if ( $this->Imagen->saveAll($this->request->data) )
			{
		...
		$this->set(compact( 'ImagenActual' , 'sliderPosiciones' ));
	}
	...
	public function getImageByPosition( $position ){
		...
		$imagen	= $this->Imagen->find('first', array('conditions' => array('slider_posicion_id' => $position)));
		return $imagen;
