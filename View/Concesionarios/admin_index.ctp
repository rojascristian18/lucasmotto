<div class="page-title">
	<h2><span class="fa fa-list"></span> Concesionarios</h2>
</div>
				...
				<table class="table">
					<thead>
						<tr class="sort">
							...
							<th><?= $this->Paginator->sort('estatus', null, array('title' => 'Haz click para ordenar por este criterio')); ?></th>
							<th>Acciones</th>
						</tr>
					</thead>
					<tbody>
						...
						<tr>
							...
							<td><?= h($concesionario['Concesionario']['fono']); ?>&nbsp;</td>
							<td><?= h($concesionario['Concesionario']['email']); ?>&nbsp;</td>
							<td><?= h($concesionario['Concesionario']['estatus']); ?>&nbsp;</td>
							<td>
