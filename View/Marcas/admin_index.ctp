		...
		<div class="panel-body">
			<div class="table-responsive">
				<table class="table">
					<thead>
						<tr class="sort">
							<th><?= $this->Paginator->sort('imagen_marca', 'Imágen Marca', array('title' => 'Haz click para ordenar por este criterio')); ?></th>
					...
					<tbody>
						...
						<tr>
							<td><?= $this->Html->image($marca['Marca']['imagen_marca']['mini']); ?>&nbsp;</td>
