<div class="page-title">
	<h2><span class="fa fa-question"></span> Preguntas Frecuentes</h2>
</div>
	...
	<div class="panel panel-default">
		<div class="panel-heading">
			...
			<div class="btn-group pull-right">
				<?= $this->Html->link('<i class="fa fa-plus"></i> Nueva Pregunta', array('action' => 'add'), array('class' => 'btn btn-success', 'escape' => false)); ?>
				...
				<table class="table">
					...
					<tbody>
						...
						<tr>
							...
							<td><?= h($pregunta['Pregunta']['respuesta']); ?>&nbsp;</td>
