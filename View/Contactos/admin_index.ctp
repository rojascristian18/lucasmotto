				...
				<table class="table">
					<thead>
						<tr class="sort">
							...
							<th><?= $this->Paginator->sort('mensaje', null, array('title' => 'Haz click para ordenar por este criterio')); ?></th>
							<th>Acciones</th>
						</tr>
					</thead>
					<tbody>
						...
						<tr>
							...
							<td><?= h($contacto['Contacto']['apellido']); ?>&nbsp;</td>
							<td><?= h($contacto['Contacto']['email']); ?>&nbsp;</td>
							<td><?= h($contacto['Contacto']['fono']); ?>&nbsp;</td>
							<td><?= h($contacto['Contacto']['mensaje']); ?>&nbsp;</td>
							<td>
