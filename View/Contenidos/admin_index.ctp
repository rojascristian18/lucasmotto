<div class="page-title">
	<h2><span class="fa fa-file"></span> Contenido de Páginas</h2>
</div>
				...
				<table class="table">
					<thead>
						<tr class="sort">
							...
							<th><?= $this->Paginator->sort('contenido', null, array('title' => 'Haz click para ordenar por este criterio')); ?></th>
							<th>Acciones</th>
						</tr>
					</thead>
					<tbody>
						...
						<tr>
							<td><?= h($contenido['Contenido']['nombre']); ?>&nbsp;</td>
							<td><?= h($contenido['Contenido']['contenido']); ?>&nbsp;</td>
							<td>
