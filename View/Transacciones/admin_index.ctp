			...
			<div class="row">
				...
				<div class="col-md-4">
					<div class="btn-group pull-right">
						<?= $this->Html->link('<i class="fa fa-plus"></i> Nueva Solicitud', array('action' => 'add'), array('class' => 'btn btn-success', 'escape' => false)); ?>
				...
				<table class="table">
					...
					<tbody>
						...
						<tr>
							...
							<td>
								<?= $this->Form->postLink('<i class="fa fa-eye"></i> Ver', array('action' => 'view', $transaccion['Transaccion']['id']), array('class' => 'btn btn-xs btn-success', 'rel' => 'tooltip', 'title' => 'Ver este registro', 'escape' => false)); ?>
